...
function Privacy(){
   ...
   <div class='mt-3 mx-3'>
      <h2>Privacy Policy</h2>
         ...
         <p>        
            <h5>Cookies & LocalStorage</h5>    
            Cookies and "LocalStorage" are files with small amount of data that is commonly used an anonymous unique 
            identifier or way to track your activity or shopping items. These are sent to your browser from the website that you visit and are stored on 
            your computer's hard drive.
            </p><p>
            Our website uses these to collection information, track your shopping cart, and to improve our Service. You have the option to either accept or refuse these cookies, and know when a cookie is being sent to your computer. If you choose to refuse our cookies, you may not be able to use some portions of our Service.
         </p>
         <p>
